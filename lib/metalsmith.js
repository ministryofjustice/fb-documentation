  ...
  .use(inplace({
    ...
    engineOptions: {
      ...
      globals: {
        ...
        getJSONCode: fileHelper.getJSONCode,
        setObject: fileHelper.setObject,
        setObjectProperty: fileHelper.setObjectProperty,
        JSON: fileHelper.JSON,
        Block: fileHelper.Block,
        setBlock: fileHelper.setBlock
      }
    }
  }))
